...
class PushRouter:
    ...
    def get_vapid_key(self) -> Optional[str]:
        return self._vapid_public_key

    def event_to_push(self, event_type: str, payload: Dict[str, Any]) -> Optional[PushPayload]:
    ...
    def route_event(self, event_type: str, payload: Dict[str, Any]) -> Optional[PushPayload]:
...
_PUSH_ROUTER: Optional[PushRouter] = None
